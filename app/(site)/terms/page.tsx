...
export default function TermsPage() {
  ...
  // Create an array of 19 sections to map over
  ...
  const schema = {
    ...
    "url": "https://www.agent-ondemand.com/terms",
    "isPartOf": { "@id": "https://www.agent-ondemand.com/#website" },
    "about": "Terms of service governing use of Agent On Demand's AI call agent and outbound calling products.",
    "publisher": { "@id": "https://www.agent-ondemand.com/#organization" }
  };

  return (
    <main className="min-h-screen bg-transparent">
      <title>{t("terms.meta.title" as TranslationKey)}</title>
      <meta name="description" content={t("terms.meta.desc" as TranslationKey)} />
      <script
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <div className="rounded-3xl p-8 md:p-10 border border-emerald-800/30 bg-[linear-gradient(135deg,#03180c_0%,#010703_100%)] shadow-[0_12px_45px_rgba(0,0,0,0.6)] mb-12 space-y-4">
            <p className="text-sm md:text-base text-[#fbf9f7]/85 leading-relaxed font-medium">
              {t("terms.intro.welcome" as TranslationKey)}
            </p>
            <p className="text-sm md:text-base text-[#fbf9f7]/85 leading-relaxed font-medium">
              {t("terms.intro.agreement" as TranslationKey)}
            </p>
          </div>
            ...
            {sections.map((num) => (
              ...
              >
                <h2 className="text-lg md:text-xl font-intrinseca text-[#fbf9f7] font-semibold mb-3">
                  {t(`terms.section.${num}.title` as TranslationKey)}
                </h2>
                <p className="text-sm text-[#fbf9f7]/70 leading-relaxed whitespace-pre-line">
                  {t(`terms.section.${num}.text` as TranslationKey)}
                </p>
              </div>
            ))}
          </div>
