...
export default function DisclaimerPage() {
  ...
  // Create an array of 4 sections to map over
  const sections = Array.from({ length: 4 }, (_, i) => i + 1);

  const schema = {
    "@context": "https://schema.org",
    "@type": "WebPage",
    "name": "Disclaimer",
    "url": "https://www.agent-ondemand.com/disclaimer",
    "isPartOf": { "@id": "https://www.agent-ondemand.com/#website" },
    "about": "Legal disclaimer regarding the accuracy, use, and limitations of information and AI-generated outputs from the Agent On Demand AI call agent website.",
    "publisher": { "@id": "https://www.agent-ondemand.com/#organization" }
  };

  return (
    <main className="min-h-screen bg-transparent">
      <title>{t("disclaimer.meta.title" as TranslationKey)}</title>
      <meta name="description" content={t("disclaimer.meta.desc" as TranslationKey)} />
      <script
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-md md:text-lg text-[#fbf9f7]/60 max-w-2xl mx-auto leading-relaxed">
              {t("disclaimer.subtitle" as TranslationKey)}
            </p>
          </div>
          ...
          <div className="rounded-3xl p-8 md:p-10 border border-emerald-800/30 bg-[linear-gradient(135deg,#03180c_0%,#010703_100%)] shadow-[0_12px_45px_rgba(0,0,0,0.6)] mb-12 space-y-4">
            <p className="text-sm md:text-base text-[#fbf9f7]/85 leading-relaxed font-medium">
              {t("disclaimer.intro.welcome" as TranslationKey)}
            </p>
            <p className="text-sm md:text-base text-[#fbf9f7]/85 leading-relaxed font-medium">
              {t("disclaimer.intro.agreement" as TranslationKey)}
            </p>
          </div>
            ...
            {sections.map((num) => (
              ...
              >
                <h2 className="text-lg md:text-xl font-intrinseca text-[#fbf9f7] font-semibold mb-3">
                  {t(`disclaimer.section.${num}.title` as TranslationKey)}
                </h2>
                <p className="text-sm text-[#fbf9f7]/70 leading-relaxed whitespace-pre-line">
                  {t(`disclaimer.section.${num}.text` as TranslationKey)}
                </p>
              </div>
            ))}
          </div>
