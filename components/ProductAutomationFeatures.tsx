...
interface AutomationFeatureItem {
    id: string;
    icon: LucideIcon;
    title: string;
    description: string;
...
interface ProductAutomationFeaturesProps {
    sectionTitle: string;
    sectionSubtitleTop: string;
    sectionSubtitleBottom?: string;
    features: AutomationFeatureItem[];
}

export default function ProductAutomationFeatures({
    sectionTitle,
    sectionSubtitleTop,
    sectionSubtitleBottom,
    features
}: ProductAutomationFeaturesProps) {
        ...
        <section className="py-24 bg-transparent relative overflow-hidden z-10">
            ...
            <div className="max-w-7xl mx-auto px-6 w-full flex flex-col gap-16 md:gap-20">
                ...
                <div className="text-center max-w-4xl mx-auto">
                    ...
                    <p className="text-[#fbf9f7]/55 text-base md:text-lg max-w-2xl mx-auto mb-4 font-medium">
                        {sectionSubtitleTop}
                    </p>
                    {sectionSubtitleBottom && (
                        <p className="text-emerald-450 text-base md:text-lg max-w-2xl mx-auto font-bold">
                            {sectionSubtitleBottom}
                        </p>
                    )}
