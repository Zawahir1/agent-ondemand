...
interface ProductAgentVsHumanProps {
    sectionTitle: string;
    beforeTitle: string;
    afterTitle: string;
    beforeItems: string[];
...
export default function ProductAgentVsHuman({
    sectionTitle,
    beforeTitle,
    afterTitle,
    beforeItems,
    afterItems
}: ProductAgentVsHumanProps) {
    ...
    // Smooth spring physics to eliminate scroll stutter
    ...
    // Zip lists together
    const zippedItems = beforeItems.map((beforeItem, idx) => ({
        id: idx + 1,
        before: beforeItem,
        after: afterItems[idx] || ""
    }));

    const cards = [
        { type: "comparison", data: zippedItems[0] },
        { type: "comparison", data: zippedItems[1] },
        { type: "comparison", data: zippedItems[2] },
        { type: "comparison", data: zippedItems[3] },
        { type: "logo" },
        { type: "comparison", data: zippedItems[4] },
        { type: "comparison", data: zippedItems[5] },
        { type: "comparison", data: zippedItems[6] },
        { type: "comparison", data: zippedItems[7] },
    ].filter(card => card.type === "logo" || card.data !== undefined);
            ...
            >
                ...
                <div className="w-full max-w-5xl mx-auto px-6 pb-12 relative z-10 flex flex-col items-center pt-16">
                    ...
                    <div className="text-center mb-12 flex flex-col items-center">
                        {/* Fixed Main Title */}
                        <h2 className="text-3xl md:text-5xl lg:text-6xl font-intrinseca text-[#fbf9f7] font-semibold leading-tight max-w-3xl mb-4">
                            {sectionTitle}
                        </h2>
