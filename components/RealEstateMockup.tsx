...
export default function RealEstateMockup() {
    ...
    const tabs = [
        { id: 0, icon: Home, label: t("realestate.mockup.tab1") },
        { id: 1, icon: CalendarDays, label: t("realestate.mockup.tab2") },
        { id: 2, icon: FileText, label: t("realestate.mockup.tab3") },
        { id: 3, icon: CheckSquare, label: t("realestate.mockup.tab4") },
    ];
                    ...
                    <div className="min-h-[220px] flex items-center justify-center">
                        <AnimatePresence mode="wait">
                            ...
                            {activeTab === 0 && (
                                ...
                                >
                                    <div className="bg-white/4 border border-white/5 rounded-2xl p-4">
                                        <span className="text-[10px] text-[#fbf9f7]/40 uppercase tracking-widest font-bold block mb-1">{t("realestate.mockup.targetProperty")}</span>
                                        <p className="text-sm font-bold text-white">{t("realestate.mockup.address")}</p>
                                        <p className="text-xs text-[#fbf9f7]/60 mt-1">{t("realestate.mockup.ref")}</p>
                                    </div>
                                    <div className="bg-white/4 border border-white/5 rounded-2xl p-4">
                                        <span className="text-[10px] text-[#fbf9f7]/40 uppercase tracking-widest font-bold block mb-1">{t("realestate.mockup.qualifiedBudget")}</span>
                                        <p className="text-sm font-bold text-emerald-450">€450,000 - €500,000</p>
                                        <p className="text-xs text-emerald-400/80 mt-1 font-semibold">{t("realestate.mockup.mortgage")}</p>
                                    </div>
                                    <div className="bg-white/4 border border-white/5 rounded-2xl p-4 sm:col-span-2">
                                        <span className="text-[10px] text-[#fbf9f7]/40 uppercase tracking-widest font-bold block mb-2">{t("realestate.mockup.desiredCriteria")}</span>
                                        <div className="flex flex-wrap gap-2">
                                            {[
                                                t("realestate.mockup.tag1"),
                                                t("realestate.mockup.tag2"),
                                                t("realestate.mockup.tag3"),
                                                t("realestate.mockup.tag4")
                                            ].map((tag, i) => (
                            ...
                            {activeTab === 1 && (
                                ...
                                >
                                    <div className="w-16 h-16 rounded-2xl bg-emerald-950/50 border border-emerald-500/30 flex flex-col items-center justify-center text-emerald-400 shadow-[0_0_15px_rgba(52,211,153,0.15)]">
                                        <span className="text-[10px] font-bold uppercase tracking-wider">{t("realestate.mockup.month")}</span>
                                    ...
                                    <div className="flex-1 space-y-1">
                                        <span className="bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-[10px] font-bold px-2 py-0.5 rounded-md uppercase tracking-wider inline-block">
                                            {t("realestate.mockup.confirmedTour")}
                                        </span>
                                        <h4 className="text-base font-bold text-white">{t("realestate.mockup.tourType")}</h4>
                                        <p className="text-xs text-[#fbf9f7]/60">{t("mockup.addressLabel" as TranslationKey)} {t("realestate.mockup.address")}</p>
                                        <p className="text-xs text-emerald-350 font-semibold">{t("realestate.mockup.viewingTime")}</p>
                                    </div>
                                    <div className="flex items-center gap-1.5 bg-emerald-900/30 border border-emerald-600/35 px-3 py-1.5 rounded-xl text-xs font-bold text-emerald-300">
                                        <Check className="w-4 h-4" /> {t("realestate.mockup.calendarSynced")}
                                    </div>
                                </motion.div>
                            )}
                            ...
                            {activeTab === 2 && (
                                ...
                                >
                                    <div className="bg-white/4 border border-white/5 rounded-2xl p-5 relative overflow-hidden">
                                        ...
                                        <h4 className="text-sm font-bold text-white mb-2">{t("realestate.mockup.caller")}</h4>
                            ...
                            {activeTab === 3 && (
                                ...
                                >
                                    {[
                                        { label: t("realestate.mockup.task1"), status: t("realestate.mockup.taskStatus1") },
                                        { label: t("realestate.mockup.task2"), status: t("realestate.mockup.taskStatus2") },
                                        { label: t("realestate.mockup.task3"), status: t("realestate.mockup.taskStatus3") },
                                    ].map((task, i) => (
