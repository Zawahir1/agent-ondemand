    ...
    const scenarios = [
        {
            ...
            titleKey: "receptionist.conversations.scenario1.title" as TranslationKey,
            icon: Calendar,
            customerTextKey: "receptionist.conversations.scenario1.customer" as TranslationKey,
            aiActionKey: "receptionist.conversations.scenario1.action" as TranslationKey,
            aiResponseKey: "receptionist.conversations.scenario1.response" as TranslationKey,
            systemLabelKey: "mockup.system.calendarRules" as TranslationKey
        },
        {
            id: 1,
            title: "Weekend Inquiries",
            titleKey: "receptionist.conversations.scenario2.title" as TranslationKey,
            icon: Clock,
            customerTextKey: "receptionist.conversations.scenario2.customer" as TranslationKey,
            aiActionKey: "receptionist.conversations.scenario2.action" as TranslationKey,
            aiResponseKey: "receptionist.conversations.scenario2.response" as TranslationKey,
            systemLabelKey: "mockup.system.businessHours" as TranslationKey
        },
        {
            id: 2,
            title: "Handover & Follow-ups",
            titleKey: "receptionist.conversations.scenario3.title" as TranslationKey,
            icon: Phone,
            customerTextKey: "receptionist.conversations.scenario3.customer" as TranslationKey,
            aiActionKey: "receptionist.conversations.scenario3.action" as TranslationKey,
            aiResponseKey: "receptionist.conversations.scenario3.response" as TranslationKey,
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
                    ...
                    <div className="lg:col-span-5 text-left space-y-8 flex flex-col justify-center">
                        <p className="text-base md:text-lg text-[#fbf9f7]/65 leading-relaxed font-medium">
                            {t("receptionist.conversations.desc")}
                        </p>
