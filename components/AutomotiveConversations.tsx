...
export default function AutomotiveConversations() {
    const { t } = useLanguage();
    ...
    const scenarios = [
        {
            ...
            titleKey: "automotive.conversations.scenario1.title" as TranslationKey,
            icon: Calendar,
            customerTextKey: "automotive.conversations.scenario1.customer" as TranslationKey,
            aiActionKey: "automotive.conversations.scenario1.action" as TranslationKey,
            aiResponseKey: "automotive.conversations.scenario1.response" as TranslationKey,
            systemLabelKey: "mockup.system.calendarRules" as TranslationKey
        },
        {
            id: 1,
            title: "Weekend Inquiries",
            titleKey: "automotive.conversations.scenario2.title" as TranslationKey,
            icon: Clock,
            customerTextKey: "automotive.conversations.scenario2.customer" as TranslationKey,
            aiActionKey: "automotive.conversations.scenario2.action" as TranslationKey,
            aiResponseKey: "automotive.conversations.scenario2.response" as TranslationKey,
            systemLabelKey: "mockup.system.businessHours" as TranslationKey
        },
        {
            id: 2,
            title: "Handover & Follow-ups",
            titleKey: "automotive.conversations.scenario3.title" as TranslationKey,
            icon: Phone,
            customerTextKey: "automotive.conversations.scenario3.customer" as TranslationKey,
            aiActionKey: "automotive.conversations.scenario3.action" as TranslationKey,
            aiResponseKey: "automotive.conversations.scenario3.response" as TranslationKey,
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
                    ...
                    <div className="lg:col-span-5 text-left space-y-8 flex flex-col justify-center">
                        <p className="text-base md:text-lg text-[#fbf9f7]/65 leading-relaxed font-medium">
                            {t("automotive.conversations.desc")}
                        </p>
